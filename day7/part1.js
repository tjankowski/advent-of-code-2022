...
const sumAtMost = Object.keys(sizes).reduce(
  (sum, dirName) => (sizes[dirName] <= 100000 ? sum + sizes[dirName] : sum),
  0
);
console.log("sumAtMost", sumAtMost);
